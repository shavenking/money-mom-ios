...
class TransactionCreateViewController: UIViewController {
    ...
    @objc private func save() {
        ...
        if let editingTransaction = self.editingTransaction {
            ...
            if let audioFileURL = MMConfig.audioFileURL(of: tempAudioUUID), FileManager.default.fileExists(atPath: audioFileURL.path) {
...
extension TransactionCreateViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, TagTextFieldDelegate, TagCollectionViewCellDelegate {
